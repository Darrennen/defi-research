      ...
      <body className={`${interTight.variable} ${sourceSerif.variable} ${jetbrainsMono.variable}`}>
        ...
        <div className="wrap">
          <footer className="site-footer">
            <div className="brand">
              <div className="mk">
                <svg viewBox="0 0 560 760" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="ad">Evidence-led analysis on digital asset markets. Independent. Data-driven.</div>
            </div>
            <div>
              <h5>Research</h5>
              <ul>
                <li><a href="/stablecoins">Stablecoins &amp; Risk</a></li>
            ...
            <div>
              <h5>Protocols</h5>
              <ul>
                <li><a href="/aave">Aave V3</a></li>
                <li><a href="/hyperlend">HyperLend</a></li>
              </ul>
            </div>
            <div>
              <h5>Data</h5>
              <ul>
                ...
                <li><a href="https://ethereum.org" target="_blank" rel="noopener">Ethereum RPC</a></li>
              </ul>
            </div>
          </footer>
          <div className="colophon">
            <div>© 2026 <span className="blue">Paragrine Research</span> · All filings are for informational purposes — not financial advice.</div>
